...
def for_test(x_t):
	...
	e_weights = os.path.join(os.path.dirname(__file__), 'model/encoder_lr0.00001_GN_te1_d05_SGD_bs6_mask_conv_bn_b_xavier.pkl')
	a_weights = os.path.join(os.path.dirname(__file__), 'model/attn_decoder_lr0.00001_GN_te1_d05_SGD_bs6_mask_conv_bn_b_xavier.pkl')
	encoder.load_state_dict(torch.load(e_weights))
	attn_decoder1.load_state_dict(torch.load(a_weights))
	...
	decoder_input_t = decoder_input_t.to(device)
